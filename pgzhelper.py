...
# override the original Actor class in PgZero
class Actor(Actor):
  ...
  def move_towards(self, actor, dist):
    ...
    # utilize trigonometry to get the movement along x and y directions.
 ...
 # move along the current direction
  ...
  # this definition is different from Scratch. It is related to current direction.
 ...
 # the following two are the images attribute's @property decorator
  @property
  def images(self):
    return self._images
 ...
 # the following is angle attribute's @property decorator
  @property
  def angle(self):
    return self._angle
 ...
 # the following is scale attribute's @property decorator
  @property
  def scale(self):
    return self._scale
 ...
 # the following is flip_x attribute's @property decorator
  @property
  def flip_x(self):
    return self._flip_x
 ...
 # the following is flip_y attribute's @property decorator
  @property
  def flip_y(self):
    return self._flip_y
  ...
  # the following is image attribute's @property decorator
  @property
  def image(self):
  ...
  # all use pygame.transform module method.
  ...
  # similar to the above. Return a list of colliding actors' index.
  ...
  # use circle to check if two sprites collide
  ...
  # use circle to check if the sprite collides with a point
